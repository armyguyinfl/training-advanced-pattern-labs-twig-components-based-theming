 ...
 * @endcode
 */
$settings['hash_salt'] = 'dUO49ZbfxXKPhHq6rd_8bTmveFnF-QpYIFmUg0L0WhWqbe_fM_KCkhuWGJK2xtiE4sy9dV7Sqg';
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_drupal_8_theme_dev_dd.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_drupal_8_theme_dev_dd.inc';
}
// </DDSETTINGS>
